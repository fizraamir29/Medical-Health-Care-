                    ...
                    {isSignUp ? (
                        <div className="w-full md:w-3/5 p-8">
                            ...
                            <form onSubmit={handleSignUp} className="flex flex-col items-center">
                                ...
                                <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-full mt-4 hover:bg-blue-700 transition duration-200">
                                    Sign Up
                                </button>
                            </form>
                            <p className="mt-6 text-gray-500">
                                Already have an account?
                                <span className="text-blue-600 cursor-pointer" onClick={() => setIsSignUp(false)}> Sign In</span>
                            </p>
                        </div>
                    ) : (
                        <div className="w-full md:w-3/5 p-8">
                            ...
                            <p className="mt-6 text-gray-500">
                                ...
                                <span className="text-blue-600 cursor-pointer" onClick={() => setIsSignUp(true)}> Create Account</span>
                            </p>
                        </div>
                    )}
