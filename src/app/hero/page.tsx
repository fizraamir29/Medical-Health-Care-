...
const Hero = () => {
    return (
        <div className='w-full mx-auto py-8 max-w-[1440px] relative bg-white'>
            <div className='flex flex-col-reverse md:flex-row gap-7 md:justify-around justify-center items-center px-12 text-center md:text-left'>
                <div className='p-4 flex-1'>
                    ...
                    <p className='text-gray-400 py-3 leading-3 tracking-wide max-w-[600px]'>
                ...
                <div className='w-[300px] md:w-[500px]'>
                    <Image
                        src="/assets/images/Hero_image.jpg" // Update the image path as needed
                        alt="Hero Image" 
